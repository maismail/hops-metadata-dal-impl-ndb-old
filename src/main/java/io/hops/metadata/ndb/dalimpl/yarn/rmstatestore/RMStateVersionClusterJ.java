...
public class RMStateVersionClusterJ implements RMStateVersionTableDef, RMStateVersionDataAccess<RMStateVersion> {
  ...
  public void add(RMStateVersion toAdd) throws StorageException {
    ...
    private VersionDTO createPersistable(RMStateVersion hop, HopsSession session) throws StorageException {
