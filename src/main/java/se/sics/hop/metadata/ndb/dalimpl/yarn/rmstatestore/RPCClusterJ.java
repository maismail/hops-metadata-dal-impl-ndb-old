...
import se.sics.hop.metadata.hdfs.entity.yarn.appmasterrpc.HopRPC;
...
public class RPCClusterJ implements RPCTableDef,
  ...
  @Override
  public boolean findByTypeAndUserId(String type, String userid) throws
          StorageException {
...
//    }
  ...
  public List<HopRPC> getAll() throws StorageException {
    try {
      ...
      //dobj.where(pred1);
      HopsQuery<RPCClusterJ.RPCDTO> query = session.createQuery(
              dobj);
